...
import CustomizeReq from '../CustomizeReq';
            ...
            {product ?
                <div className='myprod-container'>
                    ...
                    <div className='prod-data'>
                        ...
                        <div className='specific-price-conatiner'>
                        ...
                        <p className='prod-details-head'>Description</p>
                        ...
                        <div className='buy-cart'>
                            ...
                            <button className='btn-cusreq' onClick={handleShow}>Customize Request</button>
                            <Modal show={show} onHide={handleClose} size="lg">
                                <Modal.Header closeButton>
                                    <Modal.Title>Customization Request Form</Modal.Title>
                                </Modal.Header>
                                <Modal.Body><CustomizeReq /></Modal.Body>
                                <Modal.Footer>
